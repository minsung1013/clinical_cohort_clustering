...
STANDARD_OF_CARE = {
    ...
    # broad multi-cancer standard therapies (breast/prostate/renal/liver/ovarian/GBM/NET/sarcoma/…)
    "temozolomide", "doxorubicin", "liposomal doxorubicin", "ifosfamide",
    "cyclophosphamide", "dacarbazine", "cabazitaxel", "eribulin", "trabectedin", "topotecan",
    "sunitinib", "pazopanib", "cabozantinib", "axitinib", "lenvatinib", "sorafenib",
    ...
    "vemurafenib", "cobimetinib", "relatlimab",
    "lutetium lu 177", "lutetium-177", "radium-223", "radium ra 223 dichloride",
}
...
SOC_CLASS = {
    ...
    "VEGFR_TKI": {"sunitinib", "pazopanib", "cabozantinib", "axitinib", "lenvatinib",
    ...
    "IO": {"pembrolizumab", "nivolumab", "ipilimumab", "dostarlimab", "atezolizumab",
           "durvalumab", "tislelizumab", "sintilimab", "cemiplimab", "tremelimumab", "relatlimab"},
    ...
    "endocrine": {"tamoxifen", "letrozole", "anastrozole", "exemestane", "fulvestrant"},
    "AR_targeted": {"abiraterone", "enzalutamide", "apalutamide", "darolutamide",
                    "bicalutamide", "leuprolide", "goserelin", "degarelix"},
    "PARP": {"olaparib", "niraparib", "rucaparib", "talazoparib"},
    "mTOR": {"everolimus", "temsirolimus"},
    "SSTR": {"octreotide", "lanreotide"},
    "FGFR_TKI": {"erdafitinib", "pemigatinib", "futibatinib"},
    "ADC": {"enfortumab vedotin", "sacituzumab govitecan"},
    "radioligand": {"lutetium lu 177", "lutetium-177", "radium-223", "radium ra 223 dichloride"},
    # biomarker-targeted TKI classes (lung + pan-tumor)
    ...
    "BRAF_MEK": {"encorafenib", "binimetinib", "dabrafenib", "trametinib", "vemurafenib", "cobimetinib"},
